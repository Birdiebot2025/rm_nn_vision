...
{
  threshold_ = 80;
  max_angle_error_ = 57.3;  // degree to rad
  min_lightbar_ratio_ = 2;
  max_lightbar_ratio_ = 1;
  min_lightbar_length_ = 1;
  min_armor_ratio_ = 1;
  max_armor_ratio_ = 1.2;
  max_side_ratio_ = 1;
  min_confidence_ = 80;
  max_rectangular_error_ = 57.3;  // degree to rad
