...
private:
  ...
  //   static constexpr float BLADE_TOP_WIDTH = 280.0;
  // static constexpr float BLADE_BOTTOM_WIDTH = 270.0;
  // static constexpr float BLADE_TOP_HEIGHT = 140.0;
  // static constexpr float BLADE_BOTTOM_HEIGHT = 140.0;
  // static constexpr float BLADE_RADIUS = 700;

  static constexpr float BLADE_TOP_WIDTH = 285.0;
  static constexpr float BLADE_BOTTOM_WIDTH = 275;
  static constexpr float BLADE_TOP_HEIGHT = 145.0;
  static constexpr float BLADE_BOTTOM_HEIGHT = 145.0;
  static constexpr float BLADE_RADIUS = 700;
